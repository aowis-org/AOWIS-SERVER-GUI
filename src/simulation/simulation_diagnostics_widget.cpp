#include "simulation/simulation_diagnostics_widget.h"
...
SimulationDiagnosticsWidget::SimulationDiagnosticsWidget(HydraulicData *hydraulic_data, QWidget *parent)
    : QWidget(parent),
...
void SimulationDiagnosticsWidget::refresh()
{
