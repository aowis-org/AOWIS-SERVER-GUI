    ...
    : QMainWindow(parent)
{
    ...
    getOpenStreetMapTile(this->label_image_a, "/maptiles/osm/2/3/0.png");
    getOpenStreetMapTile(this->label_image_b, "/maptiles/osm/2/3/0.png");
}
...
void MainWindow::checkAPIServer()
{
    ...
    RESTClient *rest = new RESTClient("http://aowis-map.localhost:80", this);
