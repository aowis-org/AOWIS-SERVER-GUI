...
void SettingsWidget::buildShortcutSettings()
{
...
void SettingsWidget::refreshShortcutEditor(GuiShortcutId id)
{
    QKeySequenceEdit *editor = this->shortcut_editors.value(static_cast<int>(id), nullptr);
    if (editor == nullptr)
        return;
...
void SettingsWidget::refreshShortcutFilter()
{
...
void SettingsWidget::validateShortcutEditor(GuiShortcutId id, const QKeySequence &sequence)
{
...
void SettingsWidget::commitShortcutEditor(GuiShortcutId id)
{
    QKeySequenceEdit *editor = this->shortcut_editors.value(static_cast<int>(id), nullptr);
    if (editor == nullptr)
        return;
...
void SettingsWidget::showStatus(const QString &message, bool error)
{
