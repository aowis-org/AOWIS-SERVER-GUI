...
void main()
{
    ...
    // This is intentionally identical to the retained legacy link shader's
    // size calculation so pixel and metre widths do not change appearance
    // during this representation-only migration.
    ...
    vertex_color = vec4(
        style_color.rgb,
        style_state.b > 0.5 ? style_color.a : 0.0);
